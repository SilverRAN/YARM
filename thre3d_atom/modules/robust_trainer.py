...
from thre3d_atom.thre3d_reprs.classify_under_corrup import ClassificationLoss
...
def train_sh_vox_grid_vol_mod_with_posed_images_and_corruption(
    ...
    # init sds loss class
    class_loss = ClassificationLoss(sds_vol_mod.device, 
    ...
    delta = torch.randn_like(sds_vol_mod.thre3d_repr._features, device=sds_vol_mod.device, requires_grad=True)
