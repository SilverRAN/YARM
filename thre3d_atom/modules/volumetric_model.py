...
from thre3d_atom.rendering.volumetric.render_interface import RenderOut, Rays, RenderOutAttn
from thre3d_atom.rendering.volumetric.utils.misc import (
    cast_rays,
    flatten_rays,
    reshape_rendered_output,
    collate_rendered_output, reshape_rendered_output_attn, collate_rendered_output_attn,
)
...
from thre3d_atom.thre3d_reprs.renderers import RenderProcedure, RenderConfig, render_sh_voxel_grid_attn
...
class VolumetricModel:
    def __init__(
        ...
        self._render_procedure_attn = render_procedure_attn
    ...
    def render_rays(
            self, rays: Rays, delta: torch.Tensor = None, parallel_points_chunk_size: Optional[int] = None, **kwargs
    ) -> RenderOut:
        """
        ...
        return self._render_procedure(
            self._thre3d_repr, rays, delta, render_config, parallel_points_chunk_size
        )
    ...
    def render_attn(
        ...
        rendered_output = reshape_rendered_output_attn(
            collate_rendered_output_attn(rendered_chunks),
            camera_intrinsics=camera_intrinsics,
        )
