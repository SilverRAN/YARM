...
class VoxelGrid(Module):
    ...
    def forward(self, points: Tensor, delta: Tensor = None, viewdirs: Optional[Tensor] = None) -> Tensor:
        """
        ...
        if delta is not None:
            preactivated_features = self._feature_preactivation(self._features + delta)
        else:
