...
from thre3d_atom.modules.robust_trainer import train_sh_vox_grid_vol_mod_with_posed_images_and_corruption
...
def main(**kwargs) -> None:
    ...
    # train the model:
    train_sh_vox_grid_vol_mod_with_posed_images_and_corruption(
